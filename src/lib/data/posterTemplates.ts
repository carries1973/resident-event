...
export const POSTER_TEMPLATES: PosterTemplate[] = [
  ...
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    zones: {
      ...
      eventName:    { x: 540, y: 200, maxWidth: 880, align: 'center' },
  ...
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    fontScale: 0.65,
    zones: {
      logo:         { x: 870, y: 1015, maxWidth: 160, maxHeight: 55,  align: 'center' },
      eventName:    { x: 540, y: 1020, maxWidth: 860, align: 'center' },
      dateTime:     { x: 540, y: 1160, maxWidth: 800, align: 'center' },
      location:     { x: 540, y: 1210, maxWidth: 800, align: 'center' },
      cta:          { x: 540, y: 1265, maxWidth: 680, align: 'center' },
      qr:           { x: 870, y: 1200, maxWidth: 100, maxHeight: 100 },
