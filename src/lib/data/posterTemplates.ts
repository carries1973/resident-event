...
export const POSTER_TEMPLATES: PosterTemplate[] = [
  ...
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    zones: {
      ...
      dateTime:     { x: 540, y: 490, maxWidth: 800, align: 'center' },
      location:     { x: 540, y: 555, maxWidth: 800, align: 'center' },
      cta:          { x: 540, y: 620, maxWidth: 700, align: 'center' },
      qr:           { x: 930, y: 490, maxWidth: 120, maxHeight: 120 },
      buildingName: { x: 540, y: 740, maxWidth: 900, align: 'center' },
    },
    overlayScheme: 'light',
